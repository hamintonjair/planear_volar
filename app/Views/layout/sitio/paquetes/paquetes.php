   ...
   <style>
       ...
       /* Eliminar márgenes de body, header, footer, y secciones */
       body,
       header,
       footer,
       section {
       ...
       /* Ajustar las tarjetas (cards) */
       .card {
           margin: 0;
           /* Eliminar márgenes de las tarjetas */
       }

       /* Si hay contenedores específicos que necesitan ajustes */
       .container-fluid {
           padding: 0;
           /* Eliminar relleno de contenedores fluidos */

       }


       /* Otras clases que necesiten ajustes */
   </style>
   <!-- Reservation Start -->
   <div class="container-fluid bg-registration " style="margin: 30px 0;">
       <div class="container ">
